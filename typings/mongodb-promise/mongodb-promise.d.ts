...
declare module "mongodb-promise" {
  ...
  export class MongoClient{
    ...
    static connect(uri: string, options?: any): Q.Promise<Db>;
  }
  ...
  export class Db {
    ...
    public authenticate(userName: string, password: string, options?: any): Q.Promise<any>;
  ...
  //   insert(query: any, callback: (err: Error, result: any) => void): void;
    insert(query: any, options?: { safe?: any; continueOnError?: boolean; keepGoing?: boolean; serializeFunctions?: boolean; }): Q.Promise<any>;

  //   remove(selector: Object, callback?: (err: Error, result: any) => void): void;
    remove(selector: Object, options?: { safe?: any; single?: boolean; }): Q.Promise<any>;
